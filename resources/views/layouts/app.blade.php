...
{{--    <title>{{ config('app.name', 'Laravel') }}</title>--}}
    <title>League of Legends Champion API</title>
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <a style="font-size: 10px" class="navbar-brand" href="{{ url('/champion') }}">
                    {{--{{ config('app.name', 'Laravel') }}--}}
                    Champion List
                </a>
                <a style="font-size: 10px" class="navbar-brand" href="{{ url('/championSkin') }}">
                    {{--{{ config('app.name', 'Laravel') }}--}}
                    Champion Skins
                </a>
